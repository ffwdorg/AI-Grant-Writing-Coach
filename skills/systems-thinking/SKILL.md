---
description: Check whether a grant proposal understands the system it's entering — root causes vs. symptoms, ecosystem awareness, feedback loops, and unintended consequences. Use when the user says 'Run systems check' or 'Check systems thinking.'
---
...
Review the proposal in context against this question: does this solution understand the system it's entering?

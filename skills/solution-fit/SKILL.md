---
description: Check whether a grant proposal's solution matches the problem it claims to solve, with evidence of co-design. Use when the user says "Run solution fit" or "Check solution fit."
---

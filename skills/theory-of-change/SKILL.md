---
description: Check whether a grant proposal's theory of change is explicit and credible — does it explain why the intervention produces the claimed outcome? Use when the user says 'Run theory of change' or 'Check our logic model.'
---

---
description: Check if a grant proposal's problem statement is grounded in real user need. Use when the user pastes a proposal and asks for a problem clarity check, or says "Run problem clarity" or "Check problem clarity."
---

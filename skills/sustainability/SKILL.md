---
description: Check whether a grant proposal addresses financial sustainability after the grant ends — revenue model, runway, and dependency risk. Use when the user says 'Run sustainability check' or 'Check our revenue model.'
---

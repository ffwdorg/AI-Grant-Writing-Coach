---
description: Check a grant proposal's AI claims for credibility — what's actually AI, whether data and bias are handled, and whether the AI is deployed or aspirational. Use when the user says "Run AI check" or "Check AI claims." Skip if AI isn't core to the organization's work.
---
